...
<test_question_pool xmlns="http://www.ilias.de/Modules/TestQuestionPool/htlm/4_1"
                   xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                   xsi:schemaLocation="http://www.ilias.de/Modules/TestQuestionPool/htlm/4_1 http://www.ilias.de/xsd/ilias_qpl_4_1.xsd">
"""

FOOTER = "</test_question_pool>\n"

ITEM_OPEN = '  <item ident="qst_{question_id}" title="{title}" maxattempts="1">\n'
ITEM_CLOSE = "  </item>\n"
...
ITEM_METADATA = """    <qticomment/>
    ...
    <Metadata>
      <General>
        <Identifier Catalog="ILIAS" Entry="il_1600_qst_{question_id}"/>
      ...
      <Lifecycle>
        ...
        <LifecycleEvent Id="0" Event="creation">
          <DateTime>2024-01-01T00:00:00</DateTime>
        </LifecycleEvent>
        <LifecycleEvent Id="1" Event="last_change">
          <DateTime>2024-01-01T00:00:00</DateTime>
        </LifecycleEvent>
      </Lifecycle>
    </Metadata>
