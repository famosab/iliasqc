...
def create_ilias_archive(
    ...
    manifest_filename = temp_dir / f"{timestamp}__1600__qpl_{qpl_id}.xml"
    manifest = create_manifest(qpl_id, title, description, qti_id)
    manifest_filename.write_text(manifest, encoding="utf-8")
